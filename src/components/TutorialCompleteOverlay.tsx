...
export function TutorialCompleteOverlay({ onStartGame }: TutorialCompleteOverlayProps) {
  useEffect(() => {
      ...
      <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex justify-center items-center z-[100] animate-fadeIn">
        <div className="flex flex-col items-center gap-16 animate-slideUp">
          <div className="text-center">
            <h2 className="text-5xl font-bold text-white mb-4">Tutorial Complete!</h2>
            <p className="text-2xl text-white">You can now start the game. Have fun!</p>
          </div>
